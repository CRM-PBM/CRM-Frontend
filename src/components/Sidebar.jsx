...
export default function Sidebar({ sidebarOpen, setSidebarOpen, collapsed, setCollapsed }) {
    ...
    // Tentukan role: Jika user/role tidak ada, anggap 'umkm' sebagai default atau redirect
    ...
    const umkmLinks = [
        ...
        { path: '/dashboard/categories', label: 'Kategori', icon: ShoppingBasket, key: 'categories' },
                    ...
                    <div className={`p-5 border-b border-slate-100 ${collapsed ? 'p-3' : ''}`}>
                        ...
                        {!collapsed && (
                            <button
                                ...
                                className="absolute right-3 top-5 p-2 rounded-lg hover:bg-slate-50 transition-colors hidden md:block" // Tambahkan absolute jika perlu
